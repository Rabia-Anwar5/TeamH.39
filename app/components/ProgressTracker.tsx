...
// 1. Updated path alias to relative path to eliminate compilation errors
import { TopicProgress } from '../types';

interface ProgressTrackerProps {
  // 2. Bound the array cleanly to TopicProgress elements
...
export default function ProgressTracker({ progressData }: ProgressTrackerProps) {
  ...
  // Safely calculates aggregated metrics from your individual data rows
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4">
      <h3 className="text-3xl font-bold text-center mb-12 text-slate-800 dark:text-slate-100">Your Progress</h3>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-800">
        ...
        <div className="divide-y divide-gray-200 dark:divide-gray-800">
          {progressData.map((progress, idx) => (
            <div key={idx} className="px-6 py-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition">
